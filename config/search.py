...
search_terms = [ "Data Scientist", "Python Developer", "Data Engineer","Software engineer", "Machine learning Engineer", "Data Architect", "Front End Developer", "Full Stack Developer", "Web Developer", "Nodejs Developer"]
...
job_type = ["Full-time","Internship"]                      # (multiple select) "Full-time", "Part-time", "Contract", "Temporary", "Volunteer", "Internship", "Other"
on_site = ["On-site","Hybrid","Remote"]                       # (multiple select) "On-site", "Remote", "Hybrid"
